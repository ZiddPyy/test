...
$table->unsignedBigInteger('foto_id'); // Menentukan 'foto_id' sesuaidengan tipe di 'gallery_foto'
$table->foreign('foto_id')->references('foto_id')->on('gallery_foto')->onDelete('cascade'); // Membuat foreign key 'foto_id' yangmerujuk ke 'gallery_foto'
